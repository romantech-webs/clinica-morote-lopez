  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="clinica-morote-lopez";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Clínica Morote López"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="clinica-morote-lopez"
          data-primary-color="#a6c9cf"
          defer
        ></script>
      </head>
